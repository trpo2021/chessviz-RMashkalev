...
obj/pawn.o: src/pawn.c 
	gcc -Wall -I src -Werror -c -o obj/pawn.o src/pawn.c
obj/pawnattack.o: src/pawnattack.c 
	gcc -Wall -I src -Werror -c -o obj/pawnattack.o src/pawnattack.c
obj/pawnmove.o: src/pawnmove.c 
	gcc -Wall -I src -Werror -c -o obj/pawnmove.o src/pawnmove.c
obj/rook.o: src/rook.c 
	gcc -Wall -I src -Werror -c -o obj/rook.o src/rook.c
obj/rookcheck.o: src/rookcheck.c 
	gcc -Wall -I src -Werror -c -o obj/rookcheck.o src/rookcheck.c
obj/knight.o: src/knight.c 
	gcc -Wall -I src -Werror -c -o obj/knight.o src/knight.c
obj/knightcheck.o: src/knightcheck.c 
	gcc -Wall -I src -Werror -c -o obj/knightcheck.o src/knightcheck.c
obj/bishop.o: src/bishop.c 
	gcc -Wall -I src -Werror -c -o obj/bishop.o src/bishop.c
obj/bishopcheck.o: src/bishopcheck.c 
	gcc -Wall -I src -Werror -c -o obj/bishopcheck.o src/bishopcheck.c
obj/king.o: src/king.c 
	gcc -Wall -I src -Werror -c -o obj/king.o src/king.c
obj/kingcheck.o: src/kingcheck.c 
	gcc -Wall -I src -Werror -c -o obj/kingcheck.o src/kingcheck.c
obj/queen.o: src/queen.c
	gcc -Wall -I src -Werror -c -o obj/queen.o src/queen.c
obj/turncheck.o: src/turncheck.c
	gcc -Wall -I src -Werror -c -o obj/turncheck.o src/turncheck.c
obj/wincondition.o: src/wincondition.c
	gcc -Wall -I src -Werror -c -o obj/wincondition.o src/wincondition.c
obj/board_builder.o: src/board_builder.c
	gcc -Wall -I src -Werror -c -o obj/board_builder.o src/board_builder.c
...
test/mytests.o: test/mytests.c
	gcc -Wall -I thirdparty -I src -Werror -c -o test/mytests.o test/mytests.c
